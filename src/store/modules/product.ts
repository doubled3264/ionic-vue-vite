...
export default {
   ...
   getters: {
      ...
      getPurchasePrice: (state: IState) => {
         return { ...pick(state.productDetail, 'id', 'purchase_price') }
      },
      getSellingPrice: (state: IState) => {
         return { ...pick(state.productDetail, 'id', 'selling_price') }
      },
      getResellerPrice: (state: IState) => {
         return { ...pick(state.productDetail, 'id', 'reseller_price') }
      },
   },
   mutations: {
